...
| Radiality Magnification 	|       20      	| how many magnified pixels are the original pixels split into. If a video consists of 128x128 pixels, a 10 Radiality Magnification will result in a video with 1280x1280 pixels. 	|
